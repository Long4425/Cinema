...
<body class="auth-page">
    <div class="auth-card">
        ...
        <header class="auth-card__header">
            ...
            <p class="auth-card__subtitle">Tạo tài khoản mới để sử dụng dịch vụ</p>
        </header>
        ...
        <form class="auth-form" id="registerForm" action="<c:url value='/register'/>" method="post">
            <div class="form-group">
                <label class="form-label" for="fullName">Họ và tên</label>
                <input type="text" id="fullName" name="fullName" class="form-input" value="${fullName}"
            ...
            <div class="form-group">
                ...
                <span class="form-error" id="email-error" role="alert" aria-live="polite">${emailError != null ? emailError : ''}</span>
            </div>
            <div class="form-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            initEmailValidation('email', 'email-error');
            document.getElementById('registerForm').addEventListener('submit', function (e) {
                if (hasEmailError('email', 'email-error')) {
                    e.preventDefault();
                }
            });
        });
